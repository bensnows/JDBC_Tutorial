...
public class TestQueryDataByStatement {
	...
	public static void main(String[] args) {
		...
		//select by id
		final int id = 1;
		final String SELECT_All_FROM_MEMBER_ById = "Select * from MEMBER where id = "+id;
...
//		final String SELECT_All_FROM_MEMBER_ByName = "Select * from MEMBER where name = '"+userAc+"'";
		...
		try {
			...
			rs = stmt.executeQuery(SELECT_All_FROM_MEMBER_ById);
